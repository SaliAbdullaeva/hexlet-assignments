...
public class AppTest {
    ...
    void testUpdatePerson() throws Exception {
        MockHttpServletResponse responsePatch = mockMvc
                .perform(
                        patch("/people/3")
                                ...
                                .content("{\"firstName\": \"Dolores\", \"lastName\": \"Cambridge\"}")
                )
                .andReturn()
                .getResponse();
        MockHttpServletResponse response = mockMvc
        ...
        assertThat(response.getContentAsString()).contains("Dolores", "Cambridge");
    }
    ...
    void testDeletePerson() throws Exception {
        ...
        assertThat(responseGet.getContentAsString()).doesNotContain("Robert", "Lock");
    }
    // END
